...
export const setThemeMode = createAction('[Theme] Set Theme Mode', props<{ theme: ThemeType }>());

export const setTemperature = createAction('[Theme] Set Temperature', props<{ isCelsius: boolean }>());
